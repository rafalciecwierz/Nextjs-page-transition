...
const AnimatedTemplate: React.FC<PropsWithChildren> = ({ children }) => {
    ...
    return (
        <div>
            <div id="banner-1" className='min-h-screen bg-neutral-950 z-10 fixed top-0 left-0 w-1/2'></div>
            <div id="banner-2" className='min-h-screen bg-neutral-950 z-10 fixed top-0 left-1/2 w-1/2'></div>
